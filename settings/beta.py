...
SERVER_TYPE = BETA_SERVER_TYPE

ALLOWED_HOSTS = [
    "beta.pivotalenergy.net",
    "beta.neea.pivotalenergy.net",
    "beta.homeinnovation.pivotalenergy.net",
    "beta.pivotalenergysolutions.com",
    "beta.pivotal.energy",
    "beta.greenquery.com",
    "127.0.0.1",
]
