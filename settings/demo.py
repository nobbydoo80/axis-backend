"""demo.py: Django settings"""

from .base import *

__author__ = "Steven Klass"
__date__ = "1/24/13 1:12 PM"
...
SERVER_TYPE = DEMO_SERVER_TYPE

ALLOWED_HOSTS = [
    "demo.pivotalenergy.net",
    "demo.neea.pivotalenergy.net",
    "demo.homeinnovation.pivotalenergy.net",
    "demo.pivotalenergysolutions.com",
    "demo.pivotal.energy",
    "demo.greenquery.com",
    "127.0.0.1",
]
