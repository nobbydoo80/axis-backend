"""gamma.py: Django settings"""
import datetime

from .base import *

__author__ = "Steven Klass"
__date__ = "10/1/16 13:51"
...
SERVER_TYPE = GAMMA_SERVER_TYPE

ALLOWED_HOSTS = [
    "gamma.pivotalenergy.net",
    "gamma.neea.pivotalenergy.net",
    "gamma.homeinnovation.pivotalenergy.net",
    "gamma.pivotalenergysolutions.com",
    "gamma.pivotal.energy",
    "gamma.greenquery.com",
    "127.0.0.1",
]
...
json_log_name = os.path.join(os.sep, "var", "log", "django", _logfile_log)
...
CORS_ORIGIN_WHITELIST = [
    "https://gamma.pivotalenergy.net",
    "http://dev.pivotalenergy.net",
]

CUSTOMER_ETO = {
    "LEGACY_EPS_REPORT_CUTOFF_DATE": datetime.date(2020, 9, 30),
}
