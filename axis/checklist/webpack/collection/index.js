...
export default angular.module('collection', ['ui.bootstrap', 'ui.router', ngRedux, ngReduxRouter])
...
.directive('inputCollector', components.collectionApp)
...
.directive('questionListItem', components.questionListItem)
...
.directive('dateInput', fields.dateInput)
...
.directive('cascadeField', fields.cascadeField)
.directive('cascadeOption', fields.cascadeOption)
// Displays
...
.directive('copyValueButton', buttons.copyValueButton)
// Utils
