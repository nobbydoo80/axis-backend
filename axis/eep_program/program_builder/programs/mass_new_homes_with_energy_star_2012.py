...
class Program2012MassNewHomesWithEnergyStar(ProgramBuilder):
    name = "2012 Mass New Homes with Energy Star"
    slug = "2012-mass-new-homes-with-energy-star"
    ...
    close_warning = ""
    close_date = datetime.date(2021, 2, 4)
    submit_date = datetime.date(2012, 2, 4)
    submit_warning = ""
    ...
    measures = {
        "rater": {
            "default": [
                ...
                "manhes-101-building-project-information-received",
                "manhes-103-builder-applies-for-ma-energy-star-pro",
                "manhes-104-incentive-request-form-filed",
                "manhes-201-incentive-request-form-submitted-to-po",
                "manhes-202-program-enrollment-confirmation",
                "manhes-203-project-identifier-recorded",
                "manhes-204-program-year",
                "manhes-205-status-lead",
                "manhes-206-project-name",
                "manhes-207-project-city",
                "manhes-208-rater-company-aba",
                "manhes-209-electrical-sponsor",
                "manhes-210-master-meter-electric",
                "manhes-211-gas-sponsor",
                "manhes-212-master-meter-gas",
                "manhes-213-primary-heating-fuel-type",
                "manhes-214-preliminary-udrh-improvement-percentag",
                "manhes-400-permit-type-iecc-2009-stretch",
                "manhes-401-permit-number",
                "manhes-402-unit-address",
                "manhes-403-low-income",
                "manhes-405-home-type",
                "manhes-404-home-configuration",
                "manhes-406-midpoint-inspection-date",
                "manhes-407-thermal-bypass-checklist-tbctec",
                "manhes-408-prelimnay-incentive-level-targeted",
                "manhes-409-positive-heating-savings-in-performanc",
                "manhes-410-dhw-fuel-type",
                "manhes-411-positive-water-heating-savings-in-perf",
                "manhes-502-provide-lighting-option-pamphlet",
                "manhes-503-place-first-lighting-order",
                "manhes-504-place-final-lighting-order",
                "manhes-505-reconcile-lighting-orders-vs-installed",
                "manhes-601-remrate-file-name",
                "manhes-602-final-udrh-improvement-percentage",
                "manhes-603-final-inspection",
                "manhes-604-final-incentive-level",
                "manhes-605-energy-star-version-3-truefalse",
                "manhes-606-electric-meter-number",
                "manhes-607-gas-meter-number",
                "manhes-608-heating-system-1-type",
                "manhes-609-heating-system-1-afue-enter-as-decim",
                "manhes-610-heating-system-1-hspf-for-heat-pumps",
                "manhes-611-heating-system-2-type",
                "manhes-612-heating-system-2-afue-enter-as-decim",
                "manhes-613-heating-system-2-hspf-for-heat-pumps",
                "manhes-614-dhw-system-1-type",
                "manhes-615-dwh-system-1-ef",
                "manhes-616-dhw-system-2-type",
                "manhes-617-dwh-system-2-ef",
                "manhes-618-cooling-system-1-type",
                "manhes-619-cooling-system-1-seer",
                "manhes-620-txv-or-exv-verified-on-cooling-system",
                "manhes-621-cooling-system-2-type",
                "manhes-622-cooling-system-2-seer",
                "manhes-623-txv-or-exv-verified-on-cooling-system",
                "manhes-624-ac-system-qiv-completed",
                "manhes-625-ac-load-size-calcs-done-by",
                "manhes-626-ac-system-sizeing-verified-within-15",
                "manhes-627-number-of-water-sense-fixtures-install",
                "manhes-628-energy-star-refrigerator-in-unit",
                "manhes-629-energy-star-dishwasher-in-unit",
                "manhes-630-nunber-of-pin-based-fixtures",
                "manhes-631-nunber-of-leds-installed",
                "manhes-632-nunber-of-halogen-installed",
                "manhes-633-total-number-screw-based-sockets",
                "manhes-634-number-of-bulbs-ordered-from-efi-repr",
                "manhes-635-number-of-cfls-installed",
                "manhes-637-applying-for-gasnetworks-rebate-for-he",
                "manhes-638-manufacturer-of-heating-system-1",
                "manhes-639-model-number-of-heating-system-1",
                "manhes-640-manufacturer-of-dhw-system-1",
                "manhes-641-model-number-of-dhw-system-1",
                "manhes-642-applying-for-gasnetworks-rebate-for-he",
                "manhes-643-manufacturer-of-heating-system-2",
                "manhes-644-model-number-of-heating-system-2",
                "manhes-645-manufacturer-of-dhw-system-2",
                "manhes-646-model-number-of-dhw-system-2",
                "manhes-647-number-of-programmable-thermostats-con",
                "manhes-648-applying-for-cool-smart-rebate-for-sys",
                "manhes-651-ac-system-1-eer",
                "manhes-652-ahri-reference-cooling-system-1",
                "manhes-653-ac-evap-coil-1-mfg-and-model",
                "manhes-654-ac-condenser-1-mfg-and-model",
                "manhes-655-applying-for-cool-smart-rebate-for-sys",
                "manhes-656-ac-system-2-eer",
                "manhes-657-ahri-reference-cooling-system-2",
                "manhes-658-ac-evap-coil-2-mfg-and-model",
                "manhes-659-ac-condenser-2-mfg-and-model",
                "manhes-661-sent-congratulatory-email",
                "manhes-636-80-lighting-present",
                "manhes-649-programmable-thermostat-manufacturer",
                "manhes-650-programmable-thermostat-model-number",
                "manhes-660-prepare-final-dcf",
                "manhes-701-submit-final-dcf",
                "manhes-702-handle-issues",
                "manhes-703-payment-received",
                "rating-101-builder-supplied-plans-and-specificiat",
                "rating-201-google-sketchup-model-created",
                "rating-202-remrate-model-created",
                "rating-203-preliminary-reports-provided",
                "rating-204-discuss-improvement-options",
                "rating-301-thermal-entity-confirmedupdated",
                "rating-302-heating-equipment-verified",
                "rating-303-interior-cooling-equipment-verified",
                "rating-304-exterior-cooling-equipment-verified",
                "rating-305-google-sketchup-model-modified-from-fi",
                "rating-306-remrate-model-modified-based-on-field",
                "rating-401-schedule-final-inspection",
                "rating-402-confirm-final-inspection",
                "rating-403-site-visit-and-data-collection",
                "rating-404-prepare-final-remrate-model",
                "rating-405-remrate-model-heating-system-efficienc",
                "rating-408-remrate-model-duct-leakage-value-corre",
                "rating-410-remrate-model-mechanical-ventilation-v",
                "rating-409-remrate-model-air-infiltration-value-c",
                "rating-406-remrate-model-cooling-system-efficienc",
                "rating-411-remrate-model-refrigerator-efficiency",
                "rating-412-remrate-model-dishwasher-efficiency-va",
                "rating-413-remrate-model-lighting-values-correcte",
                "rating-407-remrate-model-dhw-system-efficiency-va",
    ...
    texts = {
        "rater": {
            ...
            "manhes-101-building-project-information-received": "MANHES 1.01 Building Project Information Received",
            "manhes-103-builder-applies-for-ma-energy-star-pro": "MANHES 1.03 Builder Applies for MA Energy Star Program",
            "manhes-104-incentive-request-form-filed": "MANHES 1.04 Incentive Request Form Filed",
            "manhes-201-incentive-request-form-submitted-to-po": "MANHES 2.01 Incentive Request Form Submitted to Portal",
            "manhes-202-program-enrollment-confirmation": "MANHES 2.02 Program Enrollment Confirmation",
            "manhes-203-project-identifier-recorded": "MANHES 2.03 Project Identifier Recorded ",
            "manhes-204-program-year": "MANHES 2.04 Program Year ",
            "manhes-205-status-lead": 'MANHES 2.05 Status "Lead" ',
            "manhes-206-project-name": "MANHES 2.06 Project Name",
            "manhes-207-project-city": "MANHES 2.07 Project City",
            "manhes-208-rater-company-aba": "MANHES 2.08 Rater Company (ABA)",
            "manhes-209-electrical-sponsor": "MANHES 2.09 Electrical Sponsor",
            "manhes-210-master-meter-electric": "MANHES 2.10 Master Meter Electric",
            "manhes-211-gas-sponsor": "MANHES 2.11 Gas Sponsor",
            "manhes-212-master-meter-gas": "MANHES 2.12 Master Meter Gas",
            "manhes-213-primary-heating-fuel-type": "MANHES 2.13 Primary Heating Fuel Type",
            "manhes-214-preliminary-udrh-improvement-percentag": "MANHES 2.14 Preliminary UDRH Improvement Percentage",
            "manhes-400-permit-type-iecc-2009-stretch": "MANHES 4.00 Permit Type (IECC 2009, Stretch)",
            "manhes-401-permit-number": "MANHES 4.01 Permit Number",
            "manhes-402-unit-address": "MANHES 4.02 Unit Address",
            "manhes-403-low-income": "MANHES 4.03 Low Income",
            "manhes-405-home-type": "MANHES 4.05 Home Type",
            "manhes-404-home-configuration": "MANHES 4.04 Home Configuration",
            "manhes-406-midpoint-inspection-date": "MANHES 4.06 Midpoint Inspection Date",
            "manhes-407-thermal-bypass-checklist-tbctec": "MANHES 4.07 Thermal Bypass Checklist (TBC/TEC)",
            "manhes-408-prelimnay-incentive-level-targeted": "MANHES 4.08 Prelimnay Incentive Level Targeted",
            "manhes-409-positive-heating-savings-in-performanc": "MANHES 4.09 Positive Heating Savings in Performance Factors Report?",
            "manhes-410-dhw-fuel-type": "MANHES 4.10 DHW Fuel Type",
            "manhes-411-positive-water-heating-savings-in-perf": "MANHES 4.11 Positive Water Heating Savings in Performance Factors Report?",
            "manhes-502-provide-lighting-option-pamphlet": "MANHES 5.02 Provide Lighting Option Pamphlet",
            "manhes-503-place-first-lighting-order": "MANHES 5.03 Place first lighting order",
            "manhes-504-place-final-lighting-order": "MANHES 5.04 Place final lighting order",
            "manhes-505-reconcile-lighting-orders-vs-installed": "MANHES 5.05 Reconcile lighting orders vs installed bulbs",
            "manhes-601-remrate-file-name": "MANHES 6.01 REMRate file Name",
            "manhes-602-final-udrh-improvement-percentage": "MANHES 6.02 Final UDRH Improvement Percentage",
            "manhes-603-final-inspection": "MANHES 6.03 Final Inspection",
            "manhes-604-final-incentive-level": "MANHES 6.04 Final Incentive Level",
            "manhes-605-energy-star-version-3-truefalse": "MANHES 6.05 Energy Star Version 3 [True/False]",
            "manhes-606-electric-meter-number": "MANHES 6.06 Electric Meter Number",
            "manhes-607-gas-meter-number": "MANHES 6.07 Gas Meter Number",
            "manhes-608-heating-system-1-type": "MANHES 6.08 Heating System #1 Type",
            "manhes-609-heating-system-1-afue-enter-as-decim": "MANHES 6.09 Heating System #1 AFUE (Enter as Decimal)",
            "manhes-610-heating-system-1-hspf-for-heat-pumps": "MANHES 6.10 Heating System #1 HSPF (for Heat Pumps, if Applicable)",
            "manhes-611-heating-system-2-type": "MANHES 6.11 Heating System #2 Type",
            "manhes-612-heating-system-2-afue-enter-as-decim": "MANHES 6.12 Heating System #2 AFUE (Enter as Decimal)",
            "manhes-613-heating-system-2-hspf-for-heat-pumps": "MANHES 6.13 Heating System #2 HSPF (for Heat Pumps, if Applicable)",
            "manhes-614-dhw-system-1-type": "MANHES 6.14 DHW System #1 Type",
            "manhes-615-dwh-system-1-ef": "MANHES 6.15 DWH System #1 EF",
            "manhes-616-dhw-system-2-type": "MANHES 6.16 DHW System #2 Type",
            "manhes-617-dwh-system-2-ef": "MANHES 6.17 DWH System #2 EF",
            "manhes-618-cooling-system-1-type": "MANHES 6.18 Cooling System #1 Type",
            "manhes-619-cooling-system-1-seer": "MANHES 6.19 Cooling System #1 SEER",
            "manhes-620-txv-or-exv-verified-on-cooling-system": "MANHES 6.20 TXV or EXV Verified on Cooling System #1",
            "manhes-621-cooling-system-2-type": "MANHES 6.21 Cooling System #2 Type",
            "manhes-622-cooling-system-2-seer": "MANHES 6.22 Cooling System #2 SEER",
            "manhes-623-txv-or-exv-verified-on-cooling-system": "MANHES 6.23 TXV or EXV Verified on Cooling System #2",
            "manhes-624-ac-system-qiv-completed": "MANHES 6.24 AC System QIV Completed?",
            "manhes-625-ac-load-size-calcs-done-by": "MANHES 6.25 AC Load & Size Calcs done by:",
            "manhes-626-ac-system-sizeing-verified-within-15": "MANHES 6.26 AC System Sizeing Verified within 15% or Heat Pump Verified within 25% of Total Load",
            "manhes-627-number-of-water-sense-fixtures-install": "MANHES 6.27 Number of Water Sense Fixtures Installed",
            "manhes-628-energy-star-refrigerator-in-unit": "MANHES 6.28 ENERGY STAR Refrigerator in Unit",
            "manhes-629-energy-star-dishwasher-in-unit": "MANHES 6.29 ENERGY STAR Dishwasher in Unit",
            "manhes-630-nunber-of-pin-based-fixtures": "MANHES 6.30 Nunber of Pin-based Fixtures",
            "manhes-631-nunber-of-leds-installed": "MANHES 6.31 Nunber of LEDs installed",
            "manhes-632-nunber-of-halogen-installed": "MANHES 6.32 Nunber of Halogen installed",
            "manhes-633-total-number-screw-based-sockets": "MANHES 6.33 Total Number Screw-Based Sockets",
            "manhes-634-number-of-bulbs-ordered-from-efi-repr": "MANHES 6.34 Number of Bulbs Ordered From EFI (Represents all orders currently on file)",
            "manhes-635-number-of-cfls-installed": "MANHES 6.35 Number of CFLs Installed",
            "manhes-637-applying-for-gasnetworks-rebate-for-he": "MANHES 6.37 Applying for GasNetworks Rebate for Heating or DHW System #1 ( YOU DO NOT NEED TO FILL OUT COLUMNS BJ-BV UNLESS APPLYING FOR HEATING REBATES)",
            "manhes-638-manufacturer-of-heating-system-1": "MANHES 6.38 Manufacturer of Heating System #1",
            "manhes-639-model-number-of-heating-system-1": "MANHES 6.39 Model Number of Heating System #1",
            "manhes-640-manufacturer-of-dhw-system-1": "MANHES 6.40 Manufacturer of DHW System #1",
            "manhes-641-model-number-of-dhw-system-1": "MANHES 6.41 Model Number of DHW System #1",
            "manhes-642-applying-for-gasnetworks-rebate-for-he": "MANHES 6.42 Applying for GasNetworks Rebate for Heating or DHW System #2",
            "manhes-643-manufacturer-of-heating-system-2": "MANHES 6.43 Manufacturer of Heating System #2",
            "manhes-644-model-number-of-heating-system-2": "MANHES 6.44 Model Number of Heating System #2",
            "manhes-645-manufacturer-of-dhw-system-2": "MANHES 6.45 Manufacturer of DHW System #2",
            "manhes-646-model-number-of-dhw-system-2": "MANHES 6.46 Model Number of DHW System #2",
            "manhes-647-number-of-programmable-thermostats-con": "MANHES 6.47 Number of Programmable Thermostats Controlling Natural Gas Equipment",
            "manhes-648-applying-for-cool-smart-rebate-for-sys": "MANHES 6.48 Applying for COOL SMART Rebate for System #1",
            "manhes-651-ac-system-1-eer": "MANHES 6.51 AC System #1 EER ",
            "manhes-652-ahri-reference-cooling-system-1": "MANHES 6.52 AHRI Reference # Cooling System #1",
            "manhes-653-ac-evap-coil-1-mfg-and-model": "MANHES 6.53 AC Evap Coil #1 Mfg and Model",
            "manhes-654-ac-condenser-1-mfg-and-model": "MANHES 6.54 AC Condenser #1 Mfg and Model",
            "manhes-655-applying-for-cool-smart-rebate-for-sys": "MANHES 6.55 Applying for COOL SMART Rebate for System #2",
            "manhes-656-ac-system-2-eer": "MANHES 6.56 AC System #2 EER ",
            "manhes-657-ahri-reference-cooling-system-2": "MANHES 6.57 AHRI Reference # Cooling System #2",
            "manhes-658-ac-evap-coil-2-mfg-and-model": "MANHES 6.58 AC Evap Coil #2 Mfg and Model",
            "manhes-659-ac-condenser-2-mfg-and-model": "MANHES 6.59 AC Condenser #2 Mfg and Model",
            "manhes-661-sent-congratulatory-email": "MANHES 6.61 Sent Congratulatory Email",
            "manhes-636-80-lighting-present": "MANHES 6.36 >80% Lighting Present?",
            "manhes-649-programmable-thermostat-manufacturer": "MANHES 6.49 Programmable Thermostat Manufacturer",
            "manhes-650-programmable-thermostat-model-number": "MANHES 6.50 Programmable Thermostat Model Number",
            "manhes-660-prepare-final-dcf": "MANHES 6.60 Prepare Final DCF",
            "manhes-701-submit-final-dcf": "MANHES 7.01 Submit final DCF",
            "manhes-702-handle-issues": "MANHES 7.02 Handle Issues",
            "manhes-703-payment-received": "MANHES 7.03 Payment Received",
            "rating-101-builder-supplied-plans-and-specificiat": "Rating 1.01 Builder Supplied Plans and specificiations",
            "rating-201-google-sketchup-model-created": "Rating 2.01 Google Sketchup Model Created",
            "rating-202-remrate-model-created": "Rating 2.02 RemRate Model Created",
            "rating-203-preliminary-reports-provided": "Rating 2.03 Preliminary Reports Provided",
            "rating-204-discuss-improvement-options": "Rating 2.04 Discuss Improvement  Options",
            "rating-301-thermal-entity-confirmedupdated": "Rating 3.01 Thermal Entity Confirmed/Updated",
            "rating-302-heating-equipment-verified": "Rating 3.02 Heating Equipment Verified",
            "rating-303-interior-cooling-equipment-verified": "Rating 3.03 Interior Cooling Equipment Verified",
            "rating-304-exterior-cooling-equipment-verified": "Rating 3.04 Exterior Cooling Equipment Verified",
            "rating-305-google-sketchup-model-modified-from-fi": "Rating 3.05 Google Sketchup Model Modified from field observations",
            "rating-306-remrate-model-modified-based-on-field": "Rating 3.06 RemRate Model Modified based on field observations",
            "rating-401-schedule-final-inspection": "Rating 4.01 Schedule Final Inspection",
            "rating-402-confirm-final-inspection": "Rating 4.02 Confirm Final Inspection",
            "rating-403-site-visit-and-data-collection": "Rating 4.03 Site Visit and Data Collection",
            "rating-404-prepare-final-remrate-model": "Rating 4.04 Prepare Final RemRate Model",
            "rating-405-remrate-model-heating-system-efficienc": "Rating 4.05 RemRate Model Heating system efficiency values corrected",
            "rating-408-remrate-model-duct-leakage-value-corre": "Rating 4.08 RemRate Model Duct Leakage value corrected",
            "rating-410-remrate-model-mechanical-ventilation-v": "Rating 4.10 RemRate Model Mechanical ventilation values corrected",
            "rating-409-remrate-model-air-infiltration-value-c": "Rating 4.09 RemRate Model Air Infiltration value corrected",
            "rating-406-remrate-model-cooling-system-efficienc": "Rating 4.06 RemRate Model Cooling system efficiency values corrected",
            "rating-411-remrate-model-refrigerator-efficiency": "Rating 4.11 RemRate Model Refrigerator efficiency values corrected",
            "rating-412-remrate-model-dishwasher-efficiency-va": "Rating 4.12 RemRate Model Dishwasher efficiency values corrected",
            "rating-413-remrate-model-lighting-values-correcte": "Rating 4.13 RemRate Model Lighting values corrected",
            "rating-407-remrate-model-dhw-system-efficiency-va": "Rating 4.07 RemRate Model DHW system efficiency values corrected",
    ...
    descriptions = {
        "rater": {
            ...
            <p> </p>
            <p style="text-align:center"></p>""",
            "manhes-101-building-project-information-received": """ a. Builder gives the approximate number of homes to be competed in each month of the current year.  b. Builder also gives the total number of homes in the project and the estimated year of completion.  c. Builder describes the development in general terms.""",
            "manhes-103-builder-applies-for-ma-energy-star-pro": """Application and Agreement Form provided by ICF""",
            "manhes-104-incentive-request-form-filed": """Sales Person files Incentive Request Form""",
            "manhes-201-incentive-request-form-submitted-to-po": """Incentive Request Form supplied to ICF""",
            "manhes-202-program-enrollment-confirmation": """Enrollement Confirmed""",
            "manhes-203-project-identifier-recorded": """DCF Info""",
            "manhes-204-program-year": """DCF Info""",
            "manhes-205-status-lead": """DCF Info""",
            "manhes-206-project-name": """DCF Info""",
            "manhes-207-project-city": """DCF Info""",
            "manhes-208-rater-company-aba": """DCF Info""",
            "manhes-209-electrical-sponsor": """DCF Info""",
            "manhes-210-master-meter-electric": """DCF Info""",
            "manhes-211-gas-sponsor": """DCF Info""",
            "manhes-212-master-meter-gas": """DCF Info""",
            "manhes-213-primary-heating-fuel-type": """DCF Info""",
            "manhes-214-preliminary-udrh-improvement-percentag": """Preliminary Improvement""",
            "manhes-400-permit-type-iecc-2009-stretch": """DCF Info""",
            "manhes-401-permit-number": """DCF Info""",
            "manhes-402-unit-address": """DCF Info""",
            "manhes-403-low-income": """DCF Info""",
            "manhes-405-home-type": """DCF Info""",
            "manhes-404-home-configuration": """DCF Info""",
            "manhes-406-midpoint-inspection-date": """DCF Info""",
            "manhes-407-thermal-bypass-checklist-tbctec": """DCF Info""",
            "manhes-408-prelimnay-incentive-level-targeted": """DCF Info""",
            "manhes-409-positive-heating-savings-in-performanc": """DCF Info""",
            "manhes-410-dhw-fuel-type": """DCF Info""",
            "manhes-411-positive-water-heating-savings-in-perf": """DCF Info""",
            "manhes-502-provide-lighting-option-pamphlet": """Provide lighting option pamphlet""",
            "manhes-503-place-first-lighting-order": """Place first lighting order""",
            "manhes-504-place-final-lighting-order": """Place final lighting order""",
            "manhes-601-remrate-file-name": """DCF Info""",
            "manhes-602-final-udrh-improvement-percentage": """Final Improvement""",
            "manhes-603-final-inspection": """Site Visit""",
            "manhes-604-final-incentive-level": """DCF Info""",
            "manhes-605-energy-star-version-3-truefalse": """DCF Info""",
            "manhes-606-electric-meter-number": """DCF Info""",
            "manhes-607-gas-meter-number": """DCF Info""",
            "manhes-608-heating-system-1-type": """DCF Info""",
            "manhes-609-heating-system-1-afue-enter-as-decim": """DCF Info""",
            "manhes-610-heating-system-1-hspf-for-heat-pumps": """DCF Info""",
            "manhes-611-heating-system-2-type": """DCF Info""",
            "manhes-612-heating-system-2-afue-enter-as-decim": """DCF Info""",
            "manhes-613-heating-system-2-hspf-for-heat-pumps": """DCF Info""",
            "manhes-614-dhw-system-1-type": """DCF Info""",
            "manhes-615-dwh-system-1-ef": """DCF Info""",
            "manhes-616-dhw-system-2-type": """DCF Info""",
            "manhes-617-dwh-system-2-ef": """DCF Info""",
            "manhes-618-cooling-system-1-type": """DCF Info""",
            "manhes-619-cooling-system-1-seer": """DCF Info""",
            "manhes-620-txv-or-exv-verified-on-cooling-system": """DCF Info""",
            "manhes-621-cooling-system-2-type": """DCF Info""",
            "manhes-622-cooling-system-2-seer": """DCF Info""",
            "manhes-623-txv-or-exv-verified-on-cooling-system": """DCF Info""",
            "manhes-624-ac-system-qiv-completed": """DCF Info""",
            "manhes-625-ac-load-size-calcs-done-by": """DCF Info""",
            "manhes-626-ac-system-sizeing-verified-within-15": """DCF Info""",
            "manhes-627-number-of-water-sense-fixtures-install": """DCF Info""",
            "manhes-628-energy-star-refrigerator-in-unit": """DCF Info""",
            "manhes-629-energy-star-dishwasher-in-unit": """DCF Info""",
            "manhes-630-nunber-of-pin-based-fixtures": """DCF Info""",
            "manhes-631-nunber-of-leds-installed": """DCF Info""",
            "manhes-632-nunber-of-halogen-installed": """DCF Info""",
            "manhes-633-total-number-screw-based-sockets": """DCF Info""",
            "manhes-634-number-of-bulbs-ordered-from-efi-repr": """DCF Info""",
            "manhes-635-number-of-cfls-installed": """DCF Info""",
            "manhes-637-applying-for-gasnetworks-rebate-for-he": """DCF Info""",
            "manhes-638-manufacturer-of-heating-system-1": """DCF Info""",
            "manhes-639-model-number-of-heating-system-1": """DCF Info""",
            "manhes-640-manufacturer-of-dhw-system-1": """DCF Info""",
            "manhes-641-model-number-of-dhw-system-1": """DCF Info""",
            "manhes-642-applying-for-gasnetworks-rebate-for-he": """DCF Info""",
            "manhes-643-manufacturer-of-heating-system-2": """DCF Info""",
            "manhes-644-model-number-of-heating-system-2": """DCF Info""",
            "manhes-645-manufacturer-of-dhw-system-2": """DCF Info""",
            "manhes-646-model-number-of-dhw-system-2": """DCF Info""",
            "manhes-647-number-of-programmable-thermostats-con": """DCF Info""",
            "manhes-648-applying-for-cool-smart-rebate-for-sys": """DCF Info""",
            "manhes-651-ac-system-1-eer": """DCF Info""",
            "manhes-652-ahri-reference-cooling-system-1": """DCF Info""",
            "manhes-653-ac-evap-coil-1-mfg-and-model": """DCF Info""",
            "manhes-654-ac-condenser-1-mfg-and-model": """DCF Info""",
            "manhes-655-applying-for-cool-smart-rebate-for-sys": """DCF Info""",
            "manhes-656-ac-system-2-eer": """DCF Info""",
            "manhes-657-ahri-reference-cooling-system-2": """DCF Info""",
            "manhes-658-ac-evap-coil-2-mfg-and-model": """DCF Info""",
            "manhes-659-ac-condenser-2-mfg-and-model": """DCF Info""",
            "manhes-661-sent-congratulatory-email": """Action Report,Air Leakage Report,Building File Report,Builders Affidavit,Energy Star Version Report and Summary,HERC,RESNET Standard Disclosure""",
            "manhes-636-80-lighting-present": """DCF Info""",
            "manhes-649-programmable-thermostat-manufacturer": """DCF Info""",
            "manhes-650-programmable-thermostat-model-number": """DCF Info""",
            "manhes-660-prepare-final-dcf": """Final DCF""",
            "rating-101-builder-supplied-plans-and-specificiat": """Plans on file with enough detail to perform an intial rating""",
            "rating-201-google-sketchup-model-created": """Graphical Model""",
            "rating-202-remrate-model-created": """Thermal Model""",
            "rating-203-preliminary-reports-provided": """Reports provided based on plans""",
            "rating-204-discuss-improvement-options": """Discuss the preliminary rating and improvements """,
            "rating-301-thermal-entity-confirmedupdated": """Exposed Thermal Properties collected to update/verify Thermal Model""",
            "rating-302-heating-equipment-verified": """Collect Make and Model Number of all installed Heating Equipment""",
            "rating-303-interior-cooling-equipment-verified": """Collect Make and Model Number of all Coils""",
            "rating-304-exterior-cooling-equipment-verified": """Collect Make and Model Number of all Condensers""",
            "rating-305-google-sketchup-model-modified-from-fi": """Update model based on field observations""",
            "rating-306-remrate-model-modified-based-on-field": """Update RemRate file based on field observations""",
            "rating-401-schedule-final-inspection": """Schedule Final Inspection""",
            "rating-402-confirm-final-inspection": """Confirm Final Inspection""",
            "rating-403-site-visit-and-data-collection": """Site Visit""",
            "rating-404-prepare-final-remrate-model": """Final RemRate File""",
            "rating-405-remrate-model-heating-system-efficienc": """RemRate Model Modified based on field data""",
            "rating-408-remrate-model-duct-leakage-value-corre": """RemRate Model Modified based on field data""",
            "rating-410-remrate-model-mechanical-ventilation-v": """RemRate Model Modified based on field data""",
            "rating-409-remrate-model-air-infiltration-value-c": """RemRate Model Modified based on field data""",
            "rating-406-remrate-model-cooling-system-efficienc": """RemRate Model Modified based on field data""",
            "rating-411-remrate-model-refrigerator-efficiency": """RemRate Model Modified based on field data""",
            "rating-412-remrate-model-dishwasher-efficiency-va": """RemRate Model Modified based on field data""",
            "rating-413-remrate-model-lighting-values-correcte": """RemRate Model Modified based on field data""",
            "rating-407-remrate-model-dhw-system-efficiency-va": """RemRate Model Modified based on field data""",
    ...
    suggested_responses = {
        "rater": {
            ...
            (
                "Forced-Air Furnace",
                "Forced-Air Furnace w/ ECM",
                "Hydronic Air Furnace",
                "Hot Water Boiler",
                "Steam Boiler",
                "DHW System Used for Space Heating",
                "Air-Source Heat Pump, Electric Backup",
                "Air-Source Heat Pump, Dual-Fuel",
                "Combination Boiler & DHW System",
                "Air-Source Heat Pump, Ductless Mini-Split",
                "Air-Source Heat Pump, Ducted Mini-Split",
                "Ground-Source Heat Pump, Electric Backup",
                "Ground-Source Heat Pump, Dual-Fuel",
                "Electric Resistance",
            ): [
                "manhes-608-heating-system-1-type",
            ],
            ...
            (
                "Combination Boiler & DHW System",
                "Conventional Storage (Non-Condensing)",
                "Conventional Storage (Condensing)",
                "Indirect Storage Attached to Boiler",
                "Tankless Coil Attached to Boiler (<=2 gallons)",
                "Tankless Coil Attached to Boiler (>2 gallons)",
                "Solar Thermal with Storage Tank",
                "Instantaneous",
            ): [
                "manhes-614-dhw-system-1-type",
            ],
