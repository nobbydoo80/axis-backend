"""ngbs_2015_sf_remodel_building_legacy.py: """
...
class NGBS2015SFWholeHouseRemodelLegacy(ProgramBuilder):
    name = "NGBS 2015 SF Whole House Remodel"
    slug = "ngbs-sf-whole-house-remodel-2015"
