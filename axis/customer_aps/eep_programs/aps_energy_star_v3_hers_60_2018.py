...
class ApsEnergyStarV3Hers602018(ProgramBuilder):
    ...
    visibility_date = datetime.date(2018, 8, 31)
    start_date = datetime.date(2018, 8, 31)
    close_date = datetime.date(2018, 12, 30)

    comment = """APS ENERGY STAR V3 2018 HERS 60"""
