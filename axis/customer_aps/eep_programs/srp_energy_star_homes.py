...
class SrpEnergyStarHomes(ProgramBuilder):
    name = "SRP ENERGY STAR Homes"
    slug = "srp-energy-star-homes"
    owner = "srp"
    is_qa_program = False
    opt_in = False
    ...
    visibility_date = datetime.date(2012, 5, 1)
    start_date = datetime.date(2012, 5, 1)
    close_date = datetime.date(2019, 1, 31)
