...
class Aps2015Audit(ProgramBuilder):
    name = "APS ENERGY STAR Audit"
    slug = "aps-2015-audit"
    owner = "aps"
    is_qa_program = False
    opt_in = False
    ...
    max_hers_score = 100
    per_point_adder = 0.0
    builder_incentive_dollar_value = 600.0
    ...
    visibility_date = datetime.date(2012, 4, 1)
    start_date = datetime.date(2012, 4, 1)
    close_date = datetime.date(2017, 9, 30)
    end_date = datetime.date(2017, 10, 1)

    comment = (
        """$600 incentive and can be applied at APS's discretion based on their audit results."""
    )
