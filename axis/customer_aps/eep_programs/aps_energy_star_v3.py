...
class ApsEnergyStarV3(ProgramBuilder):
    name = "APS ENERGY STAR V3"
    slug = "aps-energy-star-v3"
    owner = "aps"
    is_qa_program = False
    opt_in = False
    ...
    max_hers_score = 79
    per_point_adder = 0.0
    builder_incentive_dollar_value = 1000.0
    rater_incentive_dollar_value = 50.0
    ...
    visibility_date = datetime.date(2010, 4, 1)
    start_date = datetime.date(2010, 4, 1)
    close_date = datetime.date(2016, 12, 30)
