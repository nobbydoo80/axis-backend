...
class AzEnergyStarV32017(ProgramBuilder):
    name = "Arizona ENERGY STAR V3 2017"
    slug = "az-energy-star-v3-2017"
    owner = "az-doe"
    is_qa_program = False
    opt_in = True
    ...
    visibility_date = datetime.date(2017, 10, 1)
    start_date = datetime.date(2017, 10, 1)

    comment = """This is the Arizona ENERGY STAR V3 2017 Program"""
