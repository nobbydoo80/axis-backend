...
class CustomerHirlTopVerifiersStatsTests(ApiV3Tests):
    @classmethod
    def setUpTestData(cls):
        super(CustomerHirlTopVerifiersStatsTests, cls).setUpTestData()
    ...
    def test_verifier_by_count(self):
        EEPProgram.objects.update(slug="ngbs-mf-new-construction-2020-new", is_multi_family=True)

        url = reverse_lazy("api_v3:home_status-customer-hirl-top-verifier-stats")
        ...
        self.assertEqual(
            list(response.data["verifiers_by_project_count"]),
            [
                {
                    "verifier_first_name": self.rater.first_name,
                    "verifier_last_name": self.rater.last_name,
                    "projects_count": 2,
                }
            ],
        )
        ...
        self.assertEqual(
            list(response.data["verifiers_by_unit_count"]),
            [
                {
                    "verifier_first_name": self.rater.first_name,
                    "verifier_last_name": self.rater.last_name,
