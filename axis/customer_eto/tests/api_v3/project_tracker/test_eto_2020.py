...
from simulation.enumerations import DistributionSystemType, FuelType
from ...factories import eto_mocked_soap_responses as mocked_post
from ...program_checks.test_eto_2020 import ETO2020ProgramTestMixin
...
class TestProjectTrackerETO2020(ETO2020ProgramTestMixin, APITestCase):
    @classmethod
    def setUpTestData(cls):
        super(TestProjectTrackerETO2020, cls).setUpTestData()
        ...
        #     company=cls.simulation.company,
        # )
    ...
    def test_viewset_calculator_context_data(self):
        ...
        self.assertGreater(round(data["total_kwh"], 2), 0)
    ...
    def test_top_structure(self):
        viewset = ProjectTrackerXMLViewSet()
        context = viewset.get_legacy_calculator_context(self.project_tracker)
