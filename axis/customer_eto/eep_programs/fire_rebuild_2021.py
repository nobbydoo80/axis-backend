...
class FireResilienceBonus(Enum):
    NO = "No"
    TRIPLE_PANE = "Triple Pane Windows"
    RIGID_INSULATION = "Exterior Rigid Insulation"
    SEALED_ATTIC = "Sealed Attic"
    TRIPLE_PANE_AND_RIGID_INSULATION = "Triple Pane Windows + Exterior Rigid Insulation"
    TRIPLE_PANE_AND_SEALED_ATTIC = "Triple Pane Windows + Sealed Attic"
    RIGID_INSULATION_AND_SEALED_ATTIC = "Exterior Rigid Insulation + Sealed Attic"
    TRIPLE_PANE_AND_RIGID_INSULATION_AND_SEALED_ATTIC = (
        "Triple Pane Windows + Exterior Rigid Insulation + Sealed Attic"
    )


class FireRebuild2021(ProgramBuilder):
    """Program Specs for the ETO Fire Rebuild 2021"""

    name = "Energy Trust Oregon - 2021 Fire Rebuild"
    comment = "Energy Trust of Oregon 2021 Fire Rebuild Program"
    ...
    texts = {
        "rater": {
            ...
            "fire-rebuild-qualification": "Is this home on land that previously occupied a structure destroyed by a wildfire?",
            ...
            "building-fire-exterior-insulation-type": "What type of ignition resistant continuous exterior rigid insulation is installed?",
    ...
    descriptions = {
        "default": {
            ...
            "building-fire-exterior-insulation-type": "If Exterior Rigid Insulation",
            "building-window-triple-pane-u-value": "If Triple Pane Windows",
        },
        # 'rater': {},
        "qa": {
    ...
    suggested_responses = {
        "default": {
            AdditionalIncentives2020: ["eto-additional-incentives"],
            SolarElements2020: ["solar-elements"],
            YesNo: [
                "is-adu",
                "builder-payment-redirected",
                "has-battery-storage",
    ...
    def build_program(self):
        ...
        _program = super(FireRebuild2021, self).build_program()

        program = EEPProgram.objects.get(slug="eto-fire-2021")
