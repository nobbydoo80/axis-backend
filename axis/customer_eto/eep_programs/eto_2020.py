...
class Eto2020(ProgramBuilder):
    """Program Specs for the ETO-2020"""

    name = "Energy Trust Oregon - 2020"
    comment = "Energy Trust of Oregon 2020 Program"
    ...
    visibility_date = date(year=2019, month=11, day=1)
    start_date = date(year=2020, month=2, day=1)
    close_date = date(year=2021, month=9, day=27)
    submit_date = date(year=2021, month=9, day=30)
    ...
    def build_program(self):
        ...
        _program = super(Eto2020, self).build_program()

        program = EEPProgram.objects.get(slug="eto-2020")
