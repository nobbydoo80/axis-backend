...
/***/ function(module, exports) {
	...
	Cropper.prototype.buildDOM = function() {
	  ...
	  _elements.controls.rotateLeft = this._buildControl('rotateLeft', this.options.actionLabels.rotateLeft);
	  _elements.controls.rotateRight = this._buildControl('rotateRight', this.options.actionLabels.rotateRight);
	  _elements.controls.zoomIn = this._buildControl('zoomIn', this.options.actionLabels.zoomIn);
	  _elements.controls.zoomOut = this._buildControl('zoomOut', this.options.actionLabels.zoomOut);
	  _elements.controls.fit = this._buildControl('fit', this.options.actionLabels.fit);

	  _elements.controls.crop = this._buildControl('crop', this.options.actionLabels.crop);
	  _elements.controls.select = this._buildControl('select', this.options.actionLabels.select);
	  ...
	  _elements.controls.wrapper.appendChild(_elements.controls.select);
	 ...
	 * @returns {Element}
	 */
	Cropper.prototype._buildControl = function(name, label) {
	  var control = document.createElement('button');
	  control.setAttribute('data-name', name);
	  control.setAttribute('type', 'button');
      if (label.attrs !== undefined) {
          for (var i in label.attrs) {
              control.setAttribute(i, label.attrs[i]);
          }
    	  control.innerHTML = label.label;
      } else {
