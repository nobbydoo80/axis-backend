...
;(function($) {
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            getFormComponents = function(row) {
                if (options.getFormComponents) {
                    return options.getFormComponents(row);
                } else {
                    return row.find('input,select,textarea,label');
                }
            },
                ...
                row.find('a.' + options.deleteCssClass).click(function() {
                    ...
                    if (del.length) {
                        ...
                        for (var i=0, formCount=forms.length; i<formCount; i++) {
                            ...
                            getFormComponents(forms.eq(i)).each(function(){
        ...
        $$.each(function(i) {
            var row = $(this),
                ...
                var del_ = del.filter('[id ^= "id_'+options.prefix+'-"]');
            if (del_.length) {
                del = del_;
            }
        ...
        if ($$.length) {
            ...
            if (options.formTemplate) {
                ...
                getFormComponents(template).each(function() {
            ...
            addButton.click(function() {
                ...
                getFormComponents(row).each(function() {
    ...
    $.fn.formset.defaults = {
        ...
        getFormComponents: null          // Returns labels and inputs that need id renumbering
    };
})(jQuery)
