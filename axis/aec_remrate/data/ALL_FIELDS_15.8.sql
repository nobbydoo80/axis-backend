...
# mysql -u axis_test -p  remrate < axis/aec_remrate/data/All_FIELDS_15.8.sql

SET NAMES latin1;
SET character_set_results = NULL;
SET SQL_AUTO_IS_NULL = 0;

SET @RATING_NUMBER = CONCAT('15.7 Test: ', NOW());
...
VALUES (@BLDG_RUN, @SBRDATE, N'15.8', @RATING_NUMBER, N'', 1, 0, N'Rate', N'', N'');
...
VALUES (@BLDG_RUN, @LMAX_Building, N'ALL_FIELDS_SET_15.8.blg', @RATING_NUMBER, 2, 20.976839,
        2135.000000, 28.870138, 222.000000, 10.353401, 1104.300049, 0.000000, 0.000000, 11.608522,
        128.300003, 0.000000, 0.000000, 20.722126, 1136.010010, 0.000000, 0.000000, 15.727734,
        966.000000, 2.040816, 33.000000, 2.176664, 86.000000, 0.000000, 0.000000, 0.500000,
        N'building notes;notes line 2', 0.064814, 0.036500, N'R-50.0', N'NA', N'R-35.0', N'R-11.0',
...
VALUES (@BLDG_RUN, @LMAX_Building, N'South Wall', 22.000000, 1, 0.800000, 0.200000, 1, 0,
...
INSERT INTO Window (lBldgRunNo, lBldgNo, szWDName, fWDArea, nWDOr, fWDSumShad, fWDWtrShad,
                    nWDSurfNum, nWDSurfTyp, lWDWinTNo, sWDRateNo, fWDOHDepth, fWDOHToTop,
                    fWDOHToBtm, fWDAdjSum, fWDAdjWtr)
VALUES (@BLDG_RUN, @LMAX_Building, N'North Wall', 35.000000, 5, 0.850000, 0.250000, 2, 0,
        @LMAX_WndwType, @RATING_NUMBER, 0.000000, 0.000000, 0.000000, 1.000000, 1.000000);
SELECT @LMAX_WndwType := IFNULL((max(lWDTWinNo) + 1), 1)
FROM WndwType;
INSERT INTO WndwType (lBldgRunNo, lWDTWinNo, sWDTType, fWDTSHGC, fWDTUValue, sWDTNote)
...
INSERT INTO Window (lBldgRunNo, lBldgNo, szWDName, fWDArea, nWDOr, fWDSumShad, fWDWtrShad,
                    nWDSurfNum, nWDSurfTyp, lWDWinTNo, sWDRateNo, fWDOHDepth, fWDOHToTop,
                    fWDOHToBtm, fWDAdjSum, fWDAdjWtr)
VALUES (@BLDG_RUN, @LMAX_Building, N'East Wall', 11.000000, 3, 0.830000, 0.230000, 5, 0,
        @LMAX_WndwType, @RATING_NUMBER, 0.000000, 0.000000, 0.000000, 1.000000, 1.000000);
SELECT @LMAX_WndwType := IFNULL((max(lWDTWinNo) + 1), 1)
FROM WndwType;
INSERT INTO WndwType (lBldgRunNo, lWDTWinNo, sWDTType, fWDTSHGC, fWDTUValue, sWDTNote)
...
INSERT INTO LightApp (lBldgRunNo, lBldgNo, fLAOvnFuel, fLADryFuel, sLARateNo, nLAUseDef, fLARefKWh,
                      ...
                      fLALEDExt, fLALEDGar)
VALUES (@BLDG_RUN, @LMAX_Building, 4, 4, @RATING_NUMBER, 0, 775.000000, 0.460000, 10.000000,
        70.400002, 9.800000, 4.100000, 1.700000, 1, 12.000000, 0.000000, 0, 1, 1, 0, 2.320000,
        0.331000, 2.670000, 1, 704.000000, 2.874000, 0.080300, 0.580000, 23.000000, 1, 90.199997,
        62.200001, 8.300000);
...
VALUES (@BLDG_RUN, 1, 4, 445.604492, 0.000000, 10.004135, 0.000000, 227.330353, @RATING_NUMBER,
        0.000000, 455.608643);
INSERT INTO FuelSum (lBldgRunNo, nFSFuel, nFSUnits, fFSHCons, fFSCCons, fFSWCons, fFSLACons,
                     fFSTotCost, sRateNo, fFSPVCons, fFSTotCons)
...
INSERT INTO FuelSum (lBldgRunNo, nFSFuel, nFSUnits, fFSHCons, fFSCCons, fFSWCons, fFSLACons,
                     fFSTotCost, sRateNo, fFSPVCons, fFSTotCons)
VALUES (@BLDG_RUN, 4, 1, 2803.072754, 3256.953369, 2.539927, 8517.465820, 1003.791077,
        @RATING_NUMBER, -27.186556, 14552.845703);
INSERT INTO FuelSum (lBldgRunNo, nFSFuel, nFSUnits, fFSHCons, fFSCCons, fFSWCons, fFSLACons,
                     fFSTotCost, sRateNo, fFSPVCons, fFSTotCons)
...
INSERT INTO FuelSum (lBldgRunNo, nFSFuel, nFSUnits, fFSHCons, fFSCCons, fFSWCons, fFSLACons,
                     fFSTotCost, sRateNo, fFSPVCons, fFSTotCons)
VALUES (@BLDG_RUN, 4, 7, 10.660524, 0.000000, 0.000879, 0.790815, 11.452218, @RATING_NUMBER,
        0.000000, 11.452219);
INSERT INTO FuelSum (lBldgRunNo, nFSFuel, nFSUnits, fFSHCons, fFSCCons, fFSWCons, fFSLACons,
                     fFSTotCost, sRateNo, fFSPVCons, fFSTotCons)
VALUES (@BLDG_RUN, 4, 8, 0.000000, 3.883185, 0.000000, 1.484987, 5.368172, @RATING_NUMBER, 0.000000,
        5.368172);
...
VALUES (@BLDG_RUN, 0.795533, 2.924026, 0.475469, 8.078053, 2.403088, 1.168136, 0.050817, 10.322272,
        2.296067, 5.056059, 0.245666, -0.357105, 12.817184, 5.883573, 0.255950, 0.000000, 0.000000,
        1.460101, -1.013045, 6.599478, 1.316566, 8.827277, 0.542199, 12.734204, 6.402810, -0.000000,
        0.000000, -0.545154, 0.736387, -16.166893, 17.006624, 0.000000, -10.557180, 0.000000,
        0.000000, 43.060001, 32.503132, 0.479908, 12.721533, 92.256973, 45.503380, 0.000000,
        45.503380, 7.653562, 20.241573, 5.129372, 54.127251, 11.115882, 414.266235, 225.002945,
        1.009337, 5.177264, 150.000000, 1381.121460, 2.645075, 0.000000, 3.071728, 1.868635,
        9.799303, 3.747053, 3.266662, 53.552689, 0.000000, 62.190777, 37.832729, 198.398544,
        142.000977, 29.069851, 588.553650, -0.092787, -1.878581, 6887.609375, 1.625112, 4.724782,
        0.003482, 0.006615, 0.257930, 0.139037, @RATING_NUMBER, 21251.583984, 9.489511, 24.132940,
        8387.517578, 3532.550781, 122.804474, 9238.198242, -29.487032, 1.849278, 2.117652, 0.002252,
        5.538006, -0.017677, 10.016049, 3.871505, 0.153081, 10.124619, -0.032316, 0.000000,
        0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 9.223894);
...
VALUES (@BLDG_RUN, @RATING_NUMBER, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,
        ...
        0.000000, 0, 309.078857, 142.779999, 88.417389, 463.095734, -0.000000, 150.000000,
        1153.371948, 422.067566, 251.441376, 3.989656, 473.132935, -1.889066, 150.000000,
        1298.742554, 0, 303.651215, 399.102631, 0, 0, 0, 299.579407, 142.528610, 88.429504,
        446.554199, -0.000000, 150.000000, 1127.091797, 422.067566, 251.441376, 3.989656,
        473.132935, -1.889066, 150.000000, 1298.742554, 0, 302.661194, 399.102631, 0, 0, 0,
        249.027649, 122.432198, 88.192787, 467.365143, -0.000000, 150.000000, 1077.017822,
        422.067566, 251.441376, 3.989656, 473.132935, -1.889066, 150.000000, 1298.742554, 0,
        281.776489, 399.102631, 0, 0, 0);
...
VALUES (@BLDG_RUN, @RATING_NUMBER, -999.000000, 1361.721191, 0.000000, 0.000000, 0.000000, 0.000000,
        0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,
        0.000000, 0, 0.000000);
...
INSERT INTO IECC (lBldgRunNo, sRateNo, f98IERHCn, f98IERCCn, f98IERDCN, f98IERLACn, f98IERPVCn,
                  ...
                  bPass18IECC)
VALUES (@BLDG_RUN, @RATING_NUMBER, 20.249615, 12.786491, 29.558596, 26.080063, -0.000000, 88.674767,
        51.785545, 10.829564, 1.032816, 29.069851, -0.092787, 92.624985, 0, 0.078729, 0.068685, 0,
        0, 20.249615, 12.786491, 29.558596, 26.080063, -0.000000, 88.674767, 51.785545, 10.829564,
        1.032816, 29.069851, -0.092787, 92.624985, 0, 0.078729, 0.068685, 0, 0, 20.249615,
        12.786491, 29.558596, 26.080063, -0.000000, 88.674767, 51.785545, 10.829564, 1.032816,
        29.069851, -0.092787, 92.624985, 0, 0.078729, 0.068685, 0, 0, 20.249615, 12.786491,
        29.558596, 26.080063, -0.000000, 88.674767, 51.785545, 10.829564, 1.032816, 29.069851,
        -0.092787, 92.624985, 0, 0.078729, 0.068685, 0, 0, 228.384674, 181.028397, 89.006973,
        543.677490, -0.000000, 150.000000, 1192.097534, 342.203644, 241.977310, 5.007505,
        589.545593, -1.881747, 150.000000, 1326.852417, 0, 306.718597, 399.102631, 0, 0, 0,
        202.036575, 134.239410, 89.006973, 545.136108, -0.000000, 150.000000, 1120.419067,
        342.203644, 241.977310, 5.007505, 589.545593, -1.881747, 150.000000, 1326.852417, 0,
        306.718597, 399.102631, 0, 0, 0, 263.210205, 152.811935, 88.473358, 543.968994, -0.000000,
        150.000000, 1198.464478, 388.596436, 268.272919, 4.134217, 588.248840, -1.877608,
        150.000000, 1397.374878, 0, 303.020813, 399.102631, 0, 0, 0, 245.277039, 121.871918,
        88.198792, 467.442719, -0.000000, 150.000000, 1072.790527, 422.067566, 251.441376, 3.989656,
        473.132935, -1.889066, 150.000000, 1298.742554, 0, 278.078705, 399.102631, 0, 0, 0,
        249.027649, 122.432198, 88.192787, 467.365143, -0.000000, 150.000000, 1077.017822,
        422.067566, 251.441376, 3.989656, 473.132935, -1.889066, 150.000000, 1298.742554, 0,
        281.776489, 399.102631, 0, 0, 0, 248.222504, 122.429550, 88.194145, 462.000366, -0.000000,
        150.000000, 1070.846558, 422.067566, 251.441376, 3.989656, 473.132935, -1.889066,
        150.000000, 1298.742554, 0, 281.116486, 399.102631, 0, 0, 0);
