...
class SharedEquipment(models.Model):
    ...
    shared_equipment_number = models.IntegerField(db_column="lSharedEqKey")
    ...
    note = models.FloatField(max_length=255, db_column="sNote", blank=True, null=True)
